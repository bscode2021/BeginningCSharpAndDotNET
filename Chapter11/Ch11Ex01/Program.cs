...
{
    Console.WriteLine($"New {myAnimal} object add to Array collection, Name = {myAnimal.Name}");
}
...
Console.WriteLine($"Array collection contains {animalArrayList.Count} objects");
